...
class FixedString {
  public:
	...
	[[nodiscard]] constexpr auto c_str() const -> char const* { return m_buf.data(); }
	[[nodiscard]] constexpr auto as_view() const -> std::string_view { return std::string_view{c_str(), m_size}; }
